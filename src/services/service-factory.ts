...
import type { IScannerService } from './scanner/scanner.interface';
import { ScannerService } from './scanner/scanner.service';
import type { ISchedulerService } from './scanner/scheduler.interface';
import { SchedulerService } from './scanner/scheduler.service';
...
export class ServiceFactory implements IServiceFactory {
    ...
    private _scheduler: Lazy<ISchedulerService> = new Lazy<ISchedulerService>(() => new SchedulerService(this));
    get scheduler(): ISchedulerService {
        return this._scheduler.value;
    }
